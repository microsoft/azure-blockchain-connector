// <auto-generated/> Fork of Nethereum/src/Nethereum.JsonRpc.WebSocketClient/WebSocketClient.cs
...
namespace Microsoft.Blockchain.JsonRpc
{
    public class WebSocketClient : ClientBase, IDisposable
    {
        ...
        public WebSocketClient(string path, string headerName, string headerValue, JsonSerializerSettings jsonSerializerSettings = null, ILog log = null) : this(path, jsonSerializerSettings, log)
        {
            ...
            try
            {
                if (_clientWebSocket == null || _clientWebSocket.State != WebSocketState.Open)
                {
                    ...
                    if (string.IsNullOrEmpty(_headerName)) {
                        _clientWebSocket.Options.SetRequestHeader(_headerName, _headerValue);
                    }
